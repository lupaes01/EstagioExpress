...
<body data-new-gr-c-s-loaded="14.1088.0">
                                                                                ...
                                                                                <tr>
                                                                                    <td width="174" class="es-m-p0r esd-container-frame" valign="top" align="center">
                                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                                            <tbody>
                                                                                                <tr>
                                                                                                    <td align="left" class="esd-block-image es-m-txt-l" style="font-size: 0px;"><a target="_blank" href="https://sites.google.com/d/1lPCsCrnzloQ_n1bRk5CQ_VqBtNFA5YZ_/p/1NkN1JsW0kD50JOjJqldXE97ZR-0834gP/edit"><img src="https://mugauc.stripocdn.email/content/guids/CABINET_2f0901af10bf25770970fe4a5818c48d3122d3adfac4a9aec1ff5ec5edb5a75b/images/logo.png" alt="Logotipo" style="display: block;" title="Logotipo" height="125"></a></td>
                                                                                                </tr>
                                                                                            </tbody>
                                                                                        </table>
                                                                                    </td>
	...
	<v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" esdevVmlButton href="" 
                style="height:58px; v-text-anchor:middle; width:187px" arcsize="50%" stroke="f"  fillcolor="#f1ba0a">
                                                                ...
                                                                <tr>
                                                                    <td width="560" align="left" class="esd-container-frame">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image" style="font-size: 0px;"><a target="_blank" href><img src="https://mugauc.stripocdn.email/content/guids/CABINET_2f0901af10bf25770970fe4a5818c48d3122d3adfac4a9aec1ff5ec5edb5a75b/images/foto1.png" alt style="display: block; border-radius: 20px;" width="560" class="adapt-img"></a></td>
                                                                                </tr>
                                                                                <tr>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p15t es-p10b es-p10r es-p10l">
                                                                                        <h3 class="p_name" style="text-align: center;">Divulgue as vagas</h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p10r es-p10l">
                                                                                        ...
                                                                                        <p style="text-align: justify;">Aqui será a melhor forma para divulgar as vagas de estágio e atingir o público certo para a sua empresa</p>
                                                                    ...
                                                                    <td width="173" class="es-m-p0r es-m-p20b esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#f5f5f5" style="background-color: #f5f5f5; border-radius: 20px; border-collapse: separate;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p15t es-p10b es-p10r es-p10l">
                                                                                        <h3 class="p_name" style="text-align: center;">Acompanhe o perfil</h3>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10r es-p10l">
                                                                                        <p class="p_description" style="text-align: justify;">
                                                                                            <font style="vertical-align: inherit;">
                                                                                                <font style="vertical-align: inherit;">Veja&nbsp;as características que mais predominam nos estagiários e as que mais se encaixam na sua vaga</font>
                                                                                            </font>
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                                                    ...
                                                                    <td width="173" class="es-m-p0r esd-container-frame" align="center">
                                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#f5f5f5" style="background-color: #f5f5f5; border-radius: 20px; border-collapse: separate;">
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left" class="esd-block-text es-p15t es-p10b es-p10r es-p10l">
                                                                                        <h3 class="p_name" style="text-align: center;">
                                                                                            <font style="vertical-align: inherit;">
                                                                                                <font style="vertical-align: inherit;"></font>
                                                                                            </font>O Estagiário ideal<font style="vertical-align: inherit;">
                                                                                                <font style="vertical-align: inherit;"></font>
                                                                                            </font>
                                                                                        </h3>
                                                                                    </td>
                                                                                ...
                                                                                <tr>
                                                                                    <td class="esd-block-text es-p10r es-p10l">
                                                                                        <p style="text-align: justify;">Assim, você poderá analisar o perfil dos estagiários e escolher o mais ideal para sua empresa</p>
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                ...
                                                                <tr>
                                                                    <td width="560" class="esd-container-frame" align="center" valign="top">
                                                                        <table cellpadding="0" cellspacing="0" width="100%">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center" class="esd-block-image es-m-txt-c" style="font-size: 0px;"><a target="_blank" href="https://sites.google.com/d/1lPCsCrnzloQ_n1bRk5CQ_VqBtNFA5YZ_/p/1NkN1JsW0kD50JOjJqldXE97ZR-0834gP/edit"><img src="https://mugauc.stripocdn.email/content/guids/CABINET_2f0901af10bf25770970fe4a5818c48d3122d3adfac4a9aec1ff5ec5edb5a75b/images/logo_amarelo.png" alt="Logotipo" style="display: block;" height="165" title="Logotipo"></a></td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                                    </td>
